...
<script>
  function confirmLogout() {
    ...
    <!-- Main Container -->
    <div class="container">
        <h1>Daftar Pembacaan Meter Air</h1>
        
        <!-- Button Tambah -->
        <div class="btn-add">
            <form method="POST" action="tambah2.php">
                <button type="input" class="btn btn-success">Tambah Pembacaan</button> 
            </form>
        </div>
        ...
        <div class="table-container">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    <?php 
                    // Fetch pembacaan meter data
                    $data = mysqli_query($koneksi, "SELECT * FROM pembacaan_meter");
                    ...
                    <tr>
                        ...
                        <td><?php echo $d['tanggal_pembacaan']; ?></td>
                        <td>
                            <a role="button" class="btn btn-info btn-sm" href="ubah2.php?id=<?php echo $d['id_pembacaan_meter']; ?>">Ubah</a>
                            <a role="button" class="btn btn-danger btn-sm" href="hapus2.php?id=<?php echo $d['id_pembacaan_meter']; ?>">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
