...
<script>
  function confirmLogout() {
    ...
    <!-- Main Container -->
    <div class="container">
        <h1>Daftar Pengguna Air PDAM</h1>

        <!-- Button Tambah -->
        <div class="btn-add">
            <form method="POST" action="tambah.php">
                <button type="input" class="btn btn-success">Tambah Pengguna</button> 
            </form>
        </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a role="button" class="btn btn-info btn-sm" href="ubah.php?id=<?php echo $d['id_pelanggan']; ?>">Ubah</a>
                            <a role="button" class="btn btn-danger btn-sm" href="hapus.php?id=<?php echo $d['id_pelanggan']; ?>">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
